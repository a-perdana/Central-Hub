// firebase-config.example.js — CentralHub
// ─────────────────────────────────────────────────────────────────
...
window.ENV = {
  ...
  // Mail service (Railway) — set in Vercel env vars too.
  // NOTE (2026-08-01): MAIL_SERVICE_SECRET must NEVER appear here or in
  // window.ENV — sends go through the mailRelay Cloud Function, which
  // holds the bearer in Secret Manager.
