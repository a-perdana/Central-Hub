...
export const PROGRAMME_LINKS = {
  ...
  appraisal_system: [
    { slug: 'school-appraisals',    label: 'School Appraisals',    desc: 'Five-domain self-appraisal for partner schools; coordinators review and validate.',
      who: 'The school rates itself in Academic Hub; Eduversal coordinators then write the recommendations here',
      reads: 'The school, which acts on the recommendations. A Central Hub admin signs the appraisal off' },
    ...
    { slug: 'walkthrough-entry',    label: 'Classroom Walkthrough', desc: 'Record a short, unannounced classroom visit — 10-15 minutes, no score, shared with the teacher.',
  ...
  induction_programs: [
    ...
    { slug: 'walkthroughs',      label: 'My Induction Walkthroughs', desc: 'Your own Year-1 walkthrough log against the Window 2/3/4 targets (10 apprenticeship · 8 schools solo · 2 initiative).',
      who: 'You, while you are in your first year — with your mentor',
      reads: 'You, your mentor and the HQ Director only. Confidential (NN2) and never part of a teacher’s record' },
    { slug: 'walkthrough-review', label: 'Induction Walkthrough Review', desc: 'Director queue for submitted Year-1 walkthroughs — coaching feedback, approve or return to draft.',
      who: 'The HQ Director mentoring the specialist',
      reads: 'The specialist who submitted it. Stays inside the mentor chain (NN2)' },
