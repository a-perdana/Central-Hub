...
export const PROGRAMME_LINKS = {
  ...
  induction_programs: [
    ...
    { slug: 'induction-walkthroughs',      label: 'My Induction Walkthroughs', desc: 'Your own Year-1 walkthrough log against the Window 2/3/4 targets (10 apprenticeship · 8 schools solo · 2 initiative).',
