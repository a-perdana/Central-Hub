...
| `induction_programs/{programId}` | 41 handbook docs across 5 `handbookKind` values, seeded from `docs/induction/handbook-*.json` (6 induction tracks) + `docs/handbooks/**` (35). **Source of truth is JSON; Firestore docs are reverted on next seed.** | central_admin via seed |
